...
export const metadata: Metadata = {
  ...
  description: "Remix is more than an IDE — it's your gateway to building the decentralized future.",
};
      ...
      <section className="py-20 px-6 xl:px-20 text-center bg-background border-b border-border">
        <div className="mx-auto max-w-[1280px]">
          ...
          <p className="text-text-secondary text-lg max-w-2xl mx-auto">
            Remix is more than an IDE — it&apos;s your gateway to building the decentralized future.
          </p>
        </div>
      </section>
